...
<body>
          ...
          <div class="col-sm-2 paddingTop20">
            <nav class="nav-sidebar">
                <ul class="nav">
                    ...
                    <li><a href="user_ownpost.php">Your Blogs</a></li>
                    <li><a href="user_addpost.php">Create Blogs</a></li>
                    <li class="active"><a href="user_delete.php">Update/Delete Blogs</a></li>
    ...
    <div  style="background-color:#f6f1ec" class="col-md-10 blogShort">
        <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ ?>
           ...
           <?php echo "<a href='edit_post.php?id=".$row['id']."'>edit</a>";?>
