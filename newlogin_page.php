<?php
session_start();//for starting the session of the user who want to login
$_SESSION["authuser"]=0;

include("db.php");
if(isset($_POST['submit']))//when login button is clicked
{
  $uname=$_POST['name'];
  $pword=$_POST['pass'];
    ...
    if($stmt->rowCount() > 0)
    {
      ...
      echo "<script>
       alert('Login Success as user ');
           window.location.href='newuser_index.php';
           </script>";
...
<button class="btn btn-success my-2 my-sm-0" type="submit">Search</button>
    ...
    <div class="container">
      ...
      <div class="form-group">
          ...
          <br><br>
          <input type="submit" class="btn btn-warning" name="submit" value="login"></form><br>
          <script src="https://apis.google.com/js/platform.js" async defer></script>
          <meta name="google-signin-client_id" content="902879201932-pfa8jgks3mf3drv2pl23anuss1re60ic.apps.googleusercontent.com">
          <br>
