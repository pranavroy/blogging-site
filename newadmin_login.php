<?php
session_start();//for starting the session of the admin who want to login
$_SESSION["authuser"]=0;
...
if(isset($_POST['submit']))//when submit button is clicked
{
  ...
  elseif($password==""){ $error="<br><span class=error>Please enter the password</span><br><br>"; }
  else
  {
    $stmt = $conn->prepare("SELECT uname, password FROM admin WHERE (uname=:uname) and (password=:password)"); 
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <!-- Blog Post -->
         <form action="" method="post"><!--Admin login form -->
      <div class="form-group">
        Username:            <input type="text" class="form-control" name="name" required></div>
        <br>
        <div class="form-group">
          Password:            <input type="password" class="form-control" name="pass" required></div>
          <br><br>
