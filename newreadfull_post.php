...
if($_SESSION["authuser"]!=1){//for validating session user is authorized or not
header("Location:newlogin_page.php");//if not then redirected to login page again
}
if(isset($_POST['logout']))//when logout button is pressed
{   
    session_unset();
    header("Location:newhome_page.php");//redirected to home page
