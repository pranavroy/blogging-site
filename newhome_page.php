...
$(document).ready(function(){
    $('.widget-BlogSearch input[type="text"]').on("keyup input", function(){
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="newhome_page.php">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="newlogin_page.php">Login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="newuser1_signup.php">Signup</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="newadmin_login.php">Admin</a>
            </li>
            <li class="nav-item">
...
<button class="btn btn-success my-2 my-sm-0" type="submit">Search</button>
    ...
    <div class="container">
      ...
      <?php $i=1; while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
       ?>
          <div class="card mb-4">
            <img class="card-img-top" src="pic<?php echo $i; ?>.jpg" alt="Card image cap">
            <div class="card-body">
              <h2 class="card-title"><?php echo ($row['title']); ?></h2>
              <p class="card-text"><?php echo ($row['content']); ?></p>
              <?php echo "<a href='newreadfull_post.php?id=".$row['id']."'>Read More</a>";?>
            </div>
    ...
    <script>
      var map;
      function initMap() {
          // The location of Noida
  var noida = {lat: 28.5355, lng: 77.3910};
  // The map, centered at Noida
  var map = new google.maps.Map(
      document.getElementById('map'), {zoom: 8, center: noida});
  // The marker, positioned at Noida
  var marker = new google.maps.Marker({position: noida, map: map});
      }
    </script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCyVfOfR9i2xMDKLzTa9Nyyha_vPWJ0Vv0&callback=initMap"
    async defer></script>
             <h3>Do you want to purchase this website</h3>
