...
header("Location:newlogin_page.php");//if not authorised user then again login
}
      ...
      <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ ?>
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p class="card-text"><?php echo ($row['content']); ?><br>
              <?php echo "<a href='delete_post.php?id=".$row['id']."'>delete</a>";?><br>
           <?php echo "<a href='new_edit_post.php?id=".$row['id']."'>edit</a>";?></p>
              <?php echo "<a href='newreadfull_post.php?id=".$row['id']."'>Read Comments</a>";?>
            </div>
